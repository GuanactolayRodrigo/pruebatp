...
let productos = [
  ...
  // 2 - Crear un nuevo array con productos cuyo precio sea mayor a $20
  // (Parece un error en el enunciado, seguramente se refiere a $20000)
  ...
  const productosConIVA = productos.map(producto => ({
    ...
    precio: (producto.precio * 1.21).toFixed(2) // Se puede redondear a 2 decimales
  }));
